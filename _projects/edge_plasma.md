---
layout: page_project
title: Edge plasma turbulence
description: Three-dimensional fluid modeling of edge plasma turbulence
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/project/GBS.jpg" title="fluid" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
